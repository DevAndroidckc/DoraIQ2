                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="{{route('goi-credit.them-moi')}}" class="btn btn-info waves-effect waves-light"><i class="  la la-plus-square">Thêm Gói Credit</i></a>                             
                                <table id="Goi-credit-table" class="table dt-responsive nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <a href="{{ route('goi-credit.xoa',['id' => $goiCredit ->id]) }}" class="btn btn-danger waves-effect waves-light"><i class=" far fa-trash-alt"></i></a>
                                            </td>   
                                        </tr>
                                        @endforeach
                                    </tbody>
